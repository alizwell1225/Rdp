...
{
    // Lightweight controller to expose server operations as an API usable by forms or other callers
    public class GrpcServerController : IAsyncDisposable
    {
        ...
        public string[] GetFiles()
        {
            ...
            return Directory.EnumerateFiles(_config.StorageRoot).Select(Path.GetFileName).Where(n => n != null).ToArray()!;
        }
